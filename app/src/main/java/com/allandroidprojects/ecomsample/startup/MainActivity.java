...
//    public String gender;
    ...
    public static JSONArray activityData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityData = new JSONArray();
        mDetector = new GestureDetector(this, new EmonXGestureListener());


//        Log.d(EMONX_LOG, "TESTING");
        viewPager.setOnTouchListener(touchListener1);
        drawer.setOnTouchListener(touchListener2);
//        tabLayout.setOnTouchListener(touchListener3);
    ...
    ViewPager.OnTouchListener touchListener1 = new ViewPager.OnTouchListener(){
    ...
    DrawerLayout.OnTouchListener touchListener2 = new DrawerLayout.OnTouchListener(){
